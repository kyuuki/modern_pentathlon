...
class AthletesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athlete" do
    assert_difference('Athlete.count') do
      post athletes_url, params: { athlete: { age: @athlete.age, name: @athlete.name, note: @athlete.note, sex: @athlete.sex } }
    end
  ...
  test "should update athlete" do
    patch athlete_url(@athlete), params: { athlete: { age: @athlete.age, name: @athlete.name, note: @athlete.note, sex: @athlete.sex } }
